...
(async function() {
  ...
  if (homeTop) {
    ...
    header.innerHTML = '<h2>Voetbalkoppen</h2><p class="section-intro">Korte voetbalnieuwsberichten uit verschillende competities.</p>';
  ...
  if (homeBottom) {
    ...
    if (rest.length) {
      const header = document.createElement('div');
      header.className = 'news-section-header';
      header.innerHTML = '<h2>Meer voetbalkoppen</h2><p class="section-intro">Uitgebreidere koppen worden hieronder getoond.</p>';
